...
class AnimeControllerTest {
    ...
    void setUp() {
        ...
        BDDMockito.when(animeServiceMock.findByIdOrThrowBadRequestExdception(ArgumentMatchers.anyLong()))
    ...
    void findById_ReturnsEmptyListOfAnimes_WhenAnimeIsNotFound() {
        BDDMockito.when(animeServiceMock.findByName(ArgumentMatchers.anyString()))
    ...
    void replace_UpdatesAnime_WhenSuccessful() {
        Assertions.assertThatCode(() -> animeController.replace(AnimePutRequestBodyCreator.createAnimePustRequestbody()))
                .doesNotThrowAnyException();
        ResponseEntity<Void> entity = animeController.replace(AnimePutRequestBodyCreator.createAnimePustRequestbody());
